export const VerifyEmailTamplate = (name: string, code: string) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export const WelcomeEmailTamplate = (name: string) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export const ContactUsEmailTamplate = (name: string, email: string,subject:string, message: string) => {
  return `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
