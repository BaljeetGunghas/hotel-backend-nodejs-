...
router.put("/update-hotel", isAuthenticated_1.isAutheticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () { yield (0, hotel_controller_1.updatespacificHotelbyHotelId)(req, res); }));
